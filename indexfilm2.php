                            ...
                            <div class="modal-body">
                                <form id="formMembre" enctype="multipart/form-data" action="viewfilms/enregistrerMembre.php"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="nomMembre" id="nomMembre" class="form-control" type="text"
                                                title="Nom" required></div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="telMembre" class="col-sm-4 col-form-label">Telephone</label>
                                        <div class="col-sm-8">
                                            <input type="text" title="Téléphone" class="form-control" id="telMembre"
                                                name="telMembre" pattern="[0-9]{10}" value="" required></div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="password" class="form-control" id="pwdUsager1" name="pwdUsager1"
                                                title="Les mots de passe doivent comprendre au moins 8 caractères."
                                                pattern="[A-Za-z0-9!?-]{8,12}" placeholder="au moins 8 caractères"
                                                required></div>
                                    </div>
                                    <div class="form-group row">
